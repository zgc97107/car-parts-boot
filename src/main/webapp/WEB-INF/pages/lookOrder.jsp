...
<script>
    ...
    layui.use(['table','layer','form','laydate'],function () {
        ...
        table.render({
            ...
            , cellMinWidth: 80
            , url: '<%=request.getContextPath()%>/order.html?act=lookPage' //数据接口
            ...
            , cols: [[ //表头
                ...
                ,{
                    field: 'dealer', title: '卖家', align:'center', templet: function (data) {
                    return (data.dealer.nickname)
                    }
                }
                ,{
                ...
                ,{
                    fixed: 'right',title: '操作', width: 180, align:'center', templet: function (data) {
                        return (data.orderState == 1) ? '<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="info-doc">查看</a><a class="layui-btn layui-btn layui-btn-warm layui-btn-xs" lay-event="confirm-doc">确认收货</a>'
        ...
        function confirm(id) {
            $.ajax({
                url: '${pageContext.request.contextPath}/order.html?act=confirm',
                data: "id="+id,
                method: 'post',
